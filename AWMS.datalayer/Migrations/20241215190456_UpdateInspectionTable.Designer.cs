...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20241215190456_UpdateInspectionTable")]
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 12, 15, 22, 34, 56, 68, DateTimeKind.Local).AddTicks(269)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 12, 15, 22, 34, 56, 68, DateTimeKind.Local).AddTicks(281)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 12, 15, 22, 34, 56, 65, DateTimeKind.Local).AddTicks(7801),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 12, 15, 22, 34, 56, 65, DateTimeKind.Local).AddTicks(7822),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 12, 15, 22, 34, 56, 65, DateTimeKind.Local).AddTicks(7823),
