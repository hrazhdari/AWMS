...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20240911125902_LocationWarehouse2")]
    partial class LocationWarehouse2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 9, 11, 16, 29, 1, 820, DateTimeKind.Local).AddTicks(5911)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 9, 11, 16, 29, 1, 820, DateTimeKind.Local).AddTicks(5924)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 11, 16, 29, 1, 819, DateTimeKind.Local).AddTicks(4304),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 11, 16, 29, 1, 819, DateTimeKind.Local).AddTicks(4323),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 11, 16, 29, 1, 819, DateTimeKind.Local).AddTicks(4324),
