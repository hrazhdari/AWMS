...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20240911125517_LocationWarehouse")]
    partial class LocationWarehouse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 9, 11, 16, 25, 16, 660, DateTimeKind.Local).AddTicks(242)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 9, 11, 16, 25, 16, 660, DateTimeKind.Local).AddTicks(261)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 11, 16, 25, 16, 658, DateTimeKind.Local).AddTicks(5764),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 11, 16, 25, 16, 658, DateTimeKind.Local).AddTicks(5782),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 11, 16, 25, 16, 658, DateTimeKind.Local).AddTicks(5784),
