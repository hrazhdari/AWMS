...
namespace AWMS.app.Forms.RibbonSearch
{
    public partial class frmSearchMiv : XtraForm
    {
        ...
        public frmSearchMiv(ISearchDapperRepository searchDapperRepository)//IRequestDapperRepository requestDapperRepository,)
        {
            InitializeComponent();
        ...
        private void LoadDataIntoGrid3()
        {
            //try
            //{
            gridControl1.DataSource = _searchDapperRepository.SearchMivFillGrid2();
            //}
            //catch (Exception ex)
            //{
            //    MessageBox.Show("Error loading data: " + ex.Message);
