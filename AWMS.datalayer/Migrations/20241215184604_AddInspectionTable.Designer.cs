...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20241215184604_AddInspectionTable")]
    partial class AddInspectionTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 12, 15, 22, 16, 3, 823, DateTimeKind.Local).AddTicks(7689)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 12, 15, 22, 16, 3, 823, DateTimeKind.Local).AddTicks(7699)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 12, 15, 22, 16, 3, 821, DateTimeKind.Local).AddTicks(8458),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 12, 15, 22, 16, 3, 821, DateTimeKind.Local).AddTicks(8485),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 12, 15, 22, 16, 3, 821, DateTimeKind.Local).AddTicks(8487),
