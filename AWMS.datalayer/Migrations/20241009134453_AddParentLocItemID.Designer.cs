...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20241009134453_AddParentLocItemID")]
    partial class AddParentLocItemID
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 10, 9, 17, 14, 53, 490, DateTimeKind.Local).AddTicks(5703)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 10, 9, 17, 14, 53, 490, DateTimeKind.Local).AddTicks(5722)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 10, 9, 17, 14, 53, 482, DateTimeKind.Local).AddTicks(7883),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 10, 9, 17, 14, 53, 482, DateTimeKind.Local).AddTicks(7906),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 10, 9, 17, 14, 53, 482, DateTimeKind.Local).AddTicks(7908),
