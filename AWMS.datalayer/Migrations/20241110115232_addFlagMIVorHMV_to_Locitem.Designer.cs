...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20241110115232_addFlagMIVorHMV_to_Locitem")]
    partial class addFlagMIVorHMV_to_Locitem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 11, 10, 15, 22, 32, 464, DateTimeKind.Local).AddTicks(8143)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 11, 10, 15, 22, 32, 464, DateTimeKind.Local).AddTicks(8176)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 11, 10, 15, 22, 32, 461, DateTimeKind.Local).AddTicks(4727),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 11, 10, 15, 22, 32, 461, DateTimeKind.Local).AddTicks(4778),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 11, 10, 15, 22, 32, 461, DateTimeKind.Local).AddTicks(4780),
