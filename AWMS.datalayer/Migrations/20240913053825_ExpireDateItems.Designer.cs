...
namespace AWMS.datalayer.Migrations
{
    ...
    [Migration("20240913053825_ExpireDateItems")]
    partial class ExpireDateItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnteredDate = new DateTime(2024, 9, 13, 9, 8, 25, 10, DateTimeKind.Local).AddTicks(4902)
                        },
                        new
                        {
                            CompanyID = 2,
                            Abbreviation = "TESCO",
                            CompanyName = "Teco",
                            EnteredDate = new DateTime(2024, 9, 13, 9, 8, 25, 10, DateTimeKind.Local).AddTicks(4915)
                        });
                });
            ...
            modelBuilder.Entity("AWMS.datalayer.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationID = 1,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 13, 9, 8, 25, 9, DateTimeKind.Local).AddTicks(4935),
                        ...
                        new
                        {
                            LocationID = 2,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 13, 9, 8, 25, 9, DateTimeKind.Local).AddTicks(4955),
                        ...
                        new
                        {
                            LocationID = 3,
                            EnteredBy = 88,
                            EnteredDate = new DateTime(2024, 9, 13, 9, 8, 25, 9, DateTimeKind.Local).AddTicks(4956),
